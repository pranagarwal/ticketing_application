...
import 'package:booktickets/widgets/thick.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                          width:AppLayout.getWidth(100),child: Text(ticket['to']['name'],textAlign: TextAlign.end,
            ...
            // SHOWING THE MAIN ORANGE PART OF THE TICKET
            Container(
              decoration: BoxDecoration(
                color: isColor == null?Styles.orangeColor: Colors.white,
